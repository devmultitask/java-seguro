...
public class TesteHashingMD5 {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException {
		...
		String hash2 = ByteUtil.bytesToHexa(MD5.hashText("Eu tenho uma espada - disse Merry, saltando da cadeira."));
		System.out.println(hash2);
		String hash3 = ByteUtil.bytesToHexa(MD5.hashText("Eu tenho uma espada - disse Merry, saltando da cadeira."));
		System.out.println(hash3);
		String hash4 = ByteUtil.bytesToHexa(MD5.hashText("Eu tenho uma espada - disse Merry, saltando dA cadeira."));
		System.out.println(hash4);
		String hash5 = ByteUtil.bytesToHexa(MD5.hashText("Eu"));
		System.out.println(hash5);
		String hash6 = ByteUtil.bytesToHexa(MD5.hashText("Eu tenho uma espada - disse Merry, saltando da cadeira.Eu tenho uma espada - disse Merry, saltando da cadeira.Eu tenho uma espada - disse Merry, saltando da cadeira."));
